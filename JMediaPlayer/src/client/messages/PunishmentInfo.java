...
public class PunishmentInfo {
	...
	public enum Direction{
		 ...
		 * 	Direction
		 * @return <code>Direction</code> - the enum representing the given byte
		 */
	...
	public PunishmentInfo(String a_targetName, String a_targetIP, 
		...
		if( !setTargetName( a_targetName ) ){
			m_targetName = "";
		}
		
		if( !setTargetIP( a_targetIP ) ){
			m_targetIP = "";
		}
		
		if( !setPunishment( a_punishment) ){
			m_punishment = Punishment.INVALID;
		}
		
		if( !setDirection( a_direction ) ){
	...
	// *********************************************************
	/**
	 * Set the user name of the target to have an action taken against it.
	 * 
	...
	public boolean equals(Object a_obj){
		if( !(a_obj instanceof PunishmentInfo) || a_obj == null){
			return false;
		}
		
		PunishmentInfo objToCompare = (PunishmentInfo) a_obj;
		
		if( !objToCompare.m_punishment.equals( m_punishment ) || 
				!objToCompare.m_direction.equals( m_direction ) ||
				!objToCompare.m_targetName.equals( m_targetName ) ||
				!objToCompare.m_targetIP.equals( m_targetIP ) ){
			return false;
		}
