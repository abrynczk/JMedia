...
public class LoginMessage extends Message {
	...
	public enum LoginCondition{
		 ...
		 * @return byte, the LoginCondition in its byte-based format
		 */
		public byte getCode(){
	...
	// *********************************************************
	/**
	 * Create the complete LoginMessage, containing information on
	 * the client's login attempt.
	 * 
	...
	// *********************************************************
	/**
	 * The function does nothing in the client, as the LoginMessage
	 * is received from the server upon attempting to login.
	 */
	@Override
