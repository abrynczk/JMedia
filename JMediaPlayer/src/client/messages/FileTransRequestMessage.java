...
/**
 * Message for the initial file transfer request, to be sent to the server
 * when requesting a file transfer with another user.
 * 
...
public class FileTransRequestMessage extends FileTransferMessage {
	...
	// *********************************************************
	/**
	 * Create a complete transfer request message, ready to be sent to the
	 * server through the <code>sendMessage</code> method.
	 * 
